...
// restore the real Windows winipcfg implementation (see BraveSail/tailscale)
replace github.com/metacubex/tailscale => github.com/BraveSail/tailscale v0.0.0-20260913193331-9516c1e61ef7
